    ...
    return (
      <div className="bg-background pb-16 pt-28 text-foreground">
        <div className="next-container">
          <h1 className="mb-4 text-3xl font-semibold">Client not found</h1>
          <p className="mb-6 text-muted-foreground">
            We could not find this client profile. Explore the portfolio to see recent work.
          </p>
      ...
      <div className="next-container">
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="space-y-5">
              <span className="inline-flex rounded-full border border-border/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
                Client profile
              </span>
              <h1 className="text-4xl font-semibold md:text-5xl">{client.name}</h1>
              <p className="text-sm text-muted-foreground">
                {client.projects_count || projects.length} project{(client.projects_count || projects.length) === 1 ? '' : 's'} delivered with this client.
              </p>
              {client.website_url && (
                <Button asChild className="next-button rounded-full px-6">
        ...
        <section className="mt-12 space-y-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <h2 className="text-3xl font-semibold">Projects for {client.name}</h2>
          ...
          {projects.length > 0 ? (
            ...
            <div className="next-card text-center">
              <p className="text-lg text-foreground">No projects are published for this client yet.</p>
              <p className="mt-2 text-sm text-muted-foreground">
                More work will appear here as soon as it is published.
              </p>
            </div>
          )}
        </section>
