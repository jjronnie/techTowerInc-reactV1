        ...
        <div className="bg-background pt-24 pb-16 text-foreground md:pt-32">
            <header className="next-container next-section-padding text-center">
                <div>
                    ...
                    <h1 className="mb-6 text-4xl font-bold tracking-tighter text-balance sm:text-5xl md:text-6xl">
                        Privacy <span className="text-primary">Policy</span>
                    </h1>
                    <p className="mx-auto max-w-3xl text-lg text-balance text-muted-foreground md:text-xl">
                        Your privacy is important to us. This policy outlines
                        how TechTower Innovations Inc. collects, uses, and
            ...
            <section className="next-section-padding pt-0">
                <div className="next-container mx-auto max-w-3xl">
                    <div className="legacy-prose max-w-none text-foreground">
                        <h2 className="mt-8 mb-4 text-2xl font-semibold">
                            1. Introduction
                        </h2>
                        <p>
                            TechTower Innovations Inc. ("we", "us", "our") is
                            committed to protecting the privacy of individuals
                            who visit our website ("Visitors"), who register to
                            use our services ("Customers"), or who apply for a
                            job at TechTower Innovations ("Applicants"). This
                            Privacy Policy describes our privacy practices in
                            relation to the use of our website and the related
                            applications and services offered by us
                        ...
                        <ul className="mb-4 list-inside list-disc space-y-1">
                            <li>
                                <strong>Contact Information:</strong> When you
                                express an interest in obtaining additional
                                information about the Services or register to
                                use the Services, we may require you to provide
                                personal contact information, such as name,
                                company name, address, phone number, and email
                                address.
                            </li>
                            <li>
                                <strong>Billing Information:</strong> When
                                purchasing Services, we may require you to
                                provide financial qualification and billing
                                information, such as billing name and address,
                                credit card number, and the number of employees
                                within the organization that will be using the
                                Services.
                            </li>
                            <li>
                                <strong>Applicant Information:</strong> When you
                                apply for a job with us, we may collect
                                information such as your resume, cover letter,
                        ...
                        <ul className="mb-4 list-inside list-disc space-y-1">
                            <li>
                                <strong>Log Data:</strong> Like most websites,
                                we gather certain information automatically.
                                This information may include Internet Protocol
                                (IP) addresses, browser type, Internet Service
                                Provider (ISP), referring/exit pages, the files
                                viewed on our site (e.g., HTML pages, graphics,
                                etc.), operating system, date/time stamp, and/or
                                clickstream data to analyze trends in the
                        ...
                        <ul className="mb-4 list-inside list-disc space-y-1">
                            ...
                            <li>
                                To improve, personalize, and expand our
                                Services.
                            </li>
                            <li>
                            ...
                            <li>
                                To communicate with you, either directly or
                                through one of our partners, including for
                                customer service, to provide you with updates
                                and other information relating to the Service,
                                and for marketing and promotional purposes
                                (where permitted by law).
                            </li>
                            <li>
                                To process your transactions and for billing
                                purposes.
                            </li>
                            <li>To review your job application.</li>
                            <li>
                                For compliance purposes, including enforcing our
                                Terms of Service, or other legal rights, or as
                                may be required by applicable laws and
                                regulations or requested by any judicial process
                                or governmental agency.
                            </li>
                            <li>
                                To prevent fraud and ensure the security of our
                                Services.
                            </li>
                        </ul>
                        ...
                        <ul className="mb-4 list-inside list-disc space-y-1">
                            <li>
                                ...
                                share your personal information with third-party
                                service providers to monitor and analyze the use
                                of our Service, for payment processing, or to
                                otherwise help us operate our business.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                disclose your information if we believe it's
                                necessary to comply with a legal obligation,
                                protect our rights or property, prevent or
                                investigate possible wrongdoing in connection
                                with the Services, protect the personal safety
                                of users of the Services or the public, or
                        ...
                        <p>
                            ...
                            important to us. We use commercially acceptable
                            means to protect your personal information but
                            remember that no method of transmission over the
                            Internet, or method of electronic storage is 100%
                            secure. While we strive to use appropriate technical
                            and organizational measures to protect your personal
                        ...
                        <ul className="mb-4 list-inside list-disc space-y-1">
                            ...
                            <li>
                                ...
                                believe is inaccurate or complete information
                        ...
                        <p>
                            ...
                            <a href="mailto:info@techtowerinc.com">
                                info@techtowerinc.com
                            </a>
                            .
                        </p>
                        ...
                        <p>
                            ...
                            under 13. If you become aware that a child has
                        ...
                        <p>
                            ...
                            Updated" date. You are advised to review this
                            Privacy Policy periodically for any changes. Changes
                            to this Privacy Policy are effective when they are
                            posted on this page.
                        </p>
                        ...
                        <ul className="list-none space-y-1">
                            ...
                            <li>
                                By mail: TechTower Innovations Inc., Kireka
                                Namugongo Road, Kampala, Uganda. P.O BOX 118290.
                            </li>
                        </ul>
                    </div>
                </div>
