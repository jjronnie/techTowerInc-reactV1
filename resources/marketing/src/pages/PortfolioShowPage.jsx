        ...
        <div className="bg-background pt-28 pb-16 text-foreground">
            <div className="next-container">
                <Seo
                    ...
                    image={
                        project.seo?.og_image_url || project.featured_image_url
                    }
                    ...
                    <div className="mb-5 flex flex-wrap justify-center gap-2">
                        {categories.map((category) => (
                            <Link
                                ...
                                className="rounded-full border border-border/70 px-3 py-1 text-xs font-semibold tracking-[0.18em] text-muted-foreground uppercase transition hover:border-primary/40 hover:text-foreground"
                            >
                                {category.name}
                            </Link>
                        ))}
