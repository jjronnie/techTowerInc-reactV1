    ...
    items: [
        {
            ...
            description:
                'We communicate clearly, ship on time, and keep every project grounded in real business goals.',
            accent_color: '#6d5dfc',
        },
        {
            title: 'Quality That Performs',
            description:
                'Our websites are fast, responsive, secure, and built to convert across devices.',
            accent_color: '#ff9f43',
        },
        {
            title: 'Growth-Focused Thinking',
            description:
                'We pair design and engineering with SEO and conversion strategy so your investment keeps working.',
            accent_color: '#38b86b',
        },
    ],
};
            ...
            <div className="next-container">
                <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                    <div className="space-y-6">
                        <span className="inline-flex items-center gap-3 text-xs font-semibold tracking-[0.22em] text-foreground uppercase">
                            {content.badge_text}
