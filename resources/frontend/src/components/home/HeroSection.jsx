  ...
  return (
    <section className="relative overflow-hidden bg-background text-foreground next-section-padding pt-28 md:pt-36">
      ...
      <div className="next-container relative z-10 text-center">
        ...
        >
          Product studio for ambitious teams
        </motion.div>
        ...
        >
          Build standout digital products with{' '}
          <span className="font-serif italic font-medium">meaningful</span>{' '}
        ...
        >
          TechTower Inc delivers premium software, product strategy, and automation
          to help teams launch faster, engage users, and stay ahead of change.
        </motion.p>
        ...
        >
          <Button size="lg" asChild className="next-button rounded-full px-8">
            <Link to="/contact">
              Plan a Project <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
          </Button>
          <Button size="lg" variant="outline" asChild className="next-button-outline rounded-full px-8">
            <Link to="/portfolio">
              <PlayCircle className="mr-2 w-5 h-5" /> View Portfolio
            </Link>
          </Button>
        </motion.div>
      </div>
